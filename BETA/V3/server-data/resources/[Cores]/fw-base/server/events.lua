...
AddEventHandler('playerConnecting', function(playerName, setKickReason, deferrals)
	...
	Wait(1500)
	deferrals.update("Even je licentie aan het bekijken van Rockstar...")
	Wait(1500)
...
AddEventHandler('LSCore:ToggleDuty', function(Source)
	...
	if not Player.PlayerData.job.onduty then
		...
		TriggerClientEvent('LSCore:Notify', src, "Je bent nu in dienst!", "success")
		...
		TriggerClientEvent('LSCore:Notify', src, "Je bent nu uit dienst!", "error")
...
LSCore.Functions.CreateCallback('LSCore:RemoveBank', function(source, cb, amount)
    local Player = LSCore.Functions.GetPlayer(source)
