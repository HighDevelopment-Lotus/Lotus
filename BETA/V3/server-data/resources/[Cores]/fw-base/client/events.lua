...
AddEventHandler('LSCore:client:spawn:vehicle', function(Veh, Model)
	if IsModelValid(Model) then
		...
		Citizen.SetTimeout(100, function()
			...
			exports['fw-vehicles']:SetFuelLevel(Vehicle, GetVehicleNumberPlateText(Vehicle), 100, true)
...
RegisterNetEvent('framework-core:client:opennui')
AddEventHandler('framework-core:client:opennui', function()
