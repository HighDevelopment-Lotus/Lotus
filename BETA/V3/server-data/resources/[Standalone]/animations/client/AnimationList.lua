...
AnimationList.Dances = {
   ...
   ["dab"] = {"custom@dab", "dab", "Dab a neef", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
   ["sus"] = {"custom@suspect", "suspect", "Handjes in de lucht", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
   ["salsa"] = {"custom@salsa", "salsa", "Heeeuj salsa haaai", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["what"] = {"custom@what_idk", "what_idk", "Wtf?", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["macarena"] = {"custom@makarena", "makarena", "Heeeuj makarenaa haaai", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["maraschino"] = {"custom@maraschino", "maraschino", "Heeeuj maraschino haaai", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["circlecrunch"] = {"custom@circlecrunch", "circle_crunch", "Cruncher", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["sheesh"] = {"custom@sheeeeesh", "sheeeeesh", "Sheeeeesh enne huts", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
   ["stinker"] = {"anim@mp_player_intcelebrationfemale@stinker", "stinker", "stinker uit je kont", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
AnimationList.Emotes = {
   ...
   ["talkcash"] = {"cellphone@", "cellphone_call_listen_base", "Talk on the Cash", AnimationOptions =
   {
   ...
   ["gangidle"] = {"anim@miss@low@fin@vagos@", "idle_ped01", "Gang Idle", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle2"] = {"anim@miss@low@fin@vagos@", "idle_ped02", "Gang Idle 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle3"] = {"anim@miss@low@fin@vagos@", "idle_ped03", "Gang Idle 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle4"] = {"anim@miss@low@fin@vagos@", "idle_ped04", "Gang Idle 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle5"] = {"anim@miss@low@fin@vagos@", "idle_ped05", "Gang Idle 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle6"] = {"anim@miss@low@fin@vagos@", "idle_ped06", "Gang Idle 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle7"] = {"anim@miss@low@fin@vagos@", "idle_ped07", "Gang Idle 7", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gangidle8"] = {"anim@miss@low@fin@vagos@", "idle_ped08", "Gang Idle 8", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["chair7"] = {"missfbi4leadinoutfbi_4_int", "fbi_4_int_trv_idle_andreas", "Sit Chair 7", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["chair8"] = {"safe@franklin@ig_13", "base", "Sit Chair 8", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["chair9"] = {"anim@amb@nightclub@peds@", "anim_heists_heist_safehouse_intro_phone_couch_male", "Sit Chair 9", AnimationOptions =
   {
   ...
   ["chair10"] = {"timetable@trevor@smoking_meth@base", "base", "Sit Chair 10", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["chairside"] = {"timetable@ron@ron_ig_2_alt1", "ig_2_alt1_base", "Sit Chair Side", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["fingers"] = {"anim@mp_player_intupperdock", "idle_a", "Fingers", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["watch"] = {"amb@code_human_wander_idles_fat@male@idle_a", "idle_a_wristwatch", "Watch", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["eastside"] = {"mp_player_int_uppergang_sign_b", "mp_player_int_gang_sign_b", "Eastside Sign 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["gsign2"] = {"mp_player_int_uppergang_sign_b", "mp_player_int_gang_sign_b", "Gangsign 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign3"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@bodhi@rds@base", "exit", "Gangsign 3", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign4"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@ds@base", "idle_a", "Gangsign 4", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign5"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@low@ds@base", "idle_a", "Gangsign 5", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign6"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@rps@base", "idle_a", "Gangsign 6", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign7"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@low@ps@base", "idle_a", "Gangsign 7 ", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign8"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@std@rps@base", "idle_a", "Gangsign 8 ", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["gsign9"] = {"anim@mp_player_intincarphotographybodhi@rps@", "idle_a", "Gang Sig 9 ", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,  
   }},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["beer2"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Beer 2", AnimationOptions =
   {
    ...
    ["beer3"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Beer 3", AnimationOptions =
    {
    ...
    ["beer4"] = {"amb@world_human_drinking@beer@female@idle_a", "idle_e", "Beer 4", AnimationOptions =
    {
        Prop = 'prop_cs_beer_bot_40oz_02',
        PropBone = 28422,
   ...
   ["crazy"] = {"anim@mp_player_intcelebrationmale@freakout", "freakout", "Crazy", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteLoop = false,
   }},
   ["snap"] = {"anim@mp_player_intcelebrationmale@oh_snap", "oh_snap", "Snap", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
   }},
   ["peace"] = {"anim@mp_player_intcelebrationmale@peace", "peace", "Peace", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
  }},
