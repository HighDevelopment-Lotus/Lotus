...
-- RegisterNetEvent('framework-police:SetCopCount_new')
-- AddEventHandler('framework-police:SetCopCount_new', function(Amount)
--     CurrentCops = Amount
-- end)
...
function DropBulletCasing(Weapon)
    ...
    TriggerServerEvent("framework-police:server:create:bullet", Weapon, Coords)
end
