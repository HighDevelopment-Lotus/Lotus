...
RegisterNetEvent('framework-vehicles:client:control:vehicle')
AddEventHandler('framework-vehicles:client:control:vehicle', function(Nothing, Entity)
    if not IsPushingWheelChair then
        ...
        exports['fw-assets']:RequestAnimationDict("move_action@generic@core")
