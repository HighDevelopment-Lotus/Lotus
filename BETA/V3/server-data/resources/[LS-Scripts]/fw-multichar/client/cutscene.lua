...
local LSCore = exports['fw-base']:GetCoreObject()
 ...
 AddEventHandler('introCinematic:start', function(veri)
    SetEntityCoords(plyrId, -1015.362, -2736.775, 13.760601)
	...
	--             SetEntityCoords(PlayerPedId(), Config.Plaatsen.GeneralSpawn)
    --            end
    ...
    --  end)
     ...
     showNotify = false
      ...
      PrepareMusicEvent("AC_STOP")
      TriggerMusicEvent("AC_STOP")
    --   SetEntityCoords(plyrId, Config.Plaatsen.GeneralSpawn)
    --   Wait(52500)
end) 
