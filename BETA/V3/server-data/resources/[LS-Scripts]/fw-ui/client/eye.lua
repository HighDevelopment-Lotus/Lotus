...
function ImportEyeData(data)
    if Config.ObjectOptions[GetHashKey(data['Prop'])] == nil then
        ...
        local Enabled = data['Enabled'] or function()
            return not exports['fw-government']:GetDeathStatus()
        end
...
RegisterNetEvent('framework-ui:client:open:trunk')
AddEventHandler('framework-ui:client:open:trunk', function()
...
RegisterNetEvent('framework-ui:client:refresh')
AddEventHandler('framework-ui:client:refresh', function()
