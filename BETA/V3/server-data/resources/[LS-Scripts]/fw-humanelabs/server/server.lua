...
RegisterServerEvent('framework-humanelabs:server:locker:reward:new:2021')
AddEventHandler('framework-humanelabs:server:locker:reward:new:2021', function()
...
LSCore.Functions.CreateCallback('framework-humanelabs:server:locker:reward:new:2021', function(source, cb)
    local src = source
