...
function CreateAppartement(spawn)
    ...
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 1.5)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
...
function CreateMidHotel(spawn)
	...
	table.insert(objects, house)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 0.2)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function HouseTierTwo(spawn)
    ...
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 6.5)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function HouseTierFour(spawn)
    ...
    table.insert(objects, dt)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 0.8)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function HouseTierFive(spawn)
    ...
    table.insert(objects, dt)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 6.0)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function HouseTierSeven(spawn)
    ...
    table.insert(objects, dt)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 7.0)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function GarageTierOne(spawn)
    ...
    table.insert(objects, dt)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 0.45)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function SpawnKantoor(spawn)
    ...
    table.insert(objects, dt)
    Citizen.Wait(100)
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 4.45)
    Citizen.Wait(45)
    DoScreenFadeIn(500)
    return {objects, POIOffsets}
end
...
function HouseRobTierThree(spawn)
    ...
    SetEntityCoords(PlayerPedId(), spawn.x - POIOffsets.exit.x , spawn.y - POIOffsets.exit.y, spawn.z + 0.1)
