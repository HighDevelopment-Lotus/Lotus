	...
	if not carry.InProgress then
		...
		if closestPlayer then
			...
			if targetSrc ~= -1 then
				...
				TriggerServerEvent("fw-assets:carry:sync",targetSrc)
...
RegisterNetEvent("fw-assets:carry:syncTarget")
AddEventHandler("fw-assets:carry:syncTarget", function(targetSrc)
