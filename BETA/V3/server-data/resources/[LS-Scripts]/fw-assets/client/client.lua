LSCore, LoggedIn, DisableSeatShuff = exports['fw-base']:GetCoreObject(), false, true
...
AddEventHandler('LSCore:Client:OnPlayerLoaded', function()
    Citizen.SetTimeout(3500, function()
        ...
        LSCore.Functions.TriggerCallback("framework-assets:server:get:dui:data", function(DuiData)
...
function SetDiscordButtons()
    SetDiscordRichPresenceAction(0, 'Connecten', 'fivem://connect/k6ajmr')
    SetDiscordRichPresenceAction(1, 'Discord', 'https://discord.gg/uw9T8VvYyb')
end

RegisterNetEvent('framework-assets:client:seat:shuffle')
AddEventHandler('framework-assets:client:seat:shuffle', function()
...
RegisterNetEvent('framework-assets:client:me:show')
AddEventHandler('framework-assets:client:me:show', function(Text, Source)
...
RegisterNUICallback('CheckDevtools', function()
   TriggerServerEvent('framework-assets:server:drop')
end)
