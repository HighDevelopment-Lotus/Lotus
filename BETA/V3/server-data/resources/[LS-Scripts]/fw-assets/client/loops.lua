...
Citizen.CreateThread(function()
	while true do
		...
		SetWeaponDamageModifier(GetHashKey('WEAPON_KNUCKLE'), 0.3)
		...
		SetWeaponDamageModifier(GetHashKey('WEAPON_KATANA'), 0.2)
		SetWeaponDamageModifier(GetHashKey('WEAPON_CRUTCH'), 0.1)
		SetWeaponDamageModifier(GetHashKey('WEAPON_UNICORN'), 0.1)
		-- Guns
		SetWeaponDamageModifier(GetHashKey('WEAPON_COMBATPISTOL'), 0.5)
		SetWeaponDamageModifier(GetHashKey('WEAPON_CERAMICPISTOL'), 0.4)
		SetWeaponDamageModifier(GetHashKey('WEAPON_PISTOL'), 0.5)
		SetWeaponDamageModifier(GetHashKey('WEAPON_PISTOL_MK2'), 0.5)
		SetWeaponDamageModifier(GetHashKey('WEAPON_SNSPISTOL_MK2'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_HEAVYPISTOL'), 0.6)
		SetWeaponDamageModifier(GetHashKey('WEAPON_VINTAGEPISTOL'), 0.5)
		SetWeaponDamageModifier(GetHashKey('WEAPON_NAVYREVOLVER'), 0.4)
		SetWeaponDamageModifier(GetHashKey('WEAPON_MACHINEPISTOL'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_MACHINEPISTOL'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_MICROSMG'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_MICROSMG2'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_MICROSMG3'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_APPISTOL'), 0.4)
		SetWeaponDamageModifier(GetHashKey('WEAPON_BROWNING'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_SAWMOFFSHOTGUN'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_M4'), 0.4)
		SetWeaponDamageModifier(GetHashKey('WEAPON_ASSAULTRIFLE'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_ASSAULTRIFLE2'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_SNIPERRIFLE2'), 0.3)
		SetWeaponDamageModifier(GetHashKey('WEAPON_SNSPISTOL'), 0.3)
	end
end)
      	...
      	if LoggedIn then
      	  	if not IsPedInAnyVehicle(PlayerPedId(), false) and GetEntitySpeed(PlayerPedId()) > 2.5 then
					...
					if PlayerDist ~= -1 and PlayerDist < 2 then
						CanTackle = false
						TriggerServerEvent("framework-assets:server:tackle:player", GetPlayerServerId(Player))
						TackleAnim()
					end
      	  	    end
      	  	else
