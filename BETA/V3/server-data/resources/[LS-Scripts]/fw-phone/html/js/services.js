...
$(document).on('click', '.service-header-tab', function(e){
    ...
    if (PressedServiceTab !== CurrentServiceTab) {
        ...
        if (PressedServiceTab === "service-estateagent") {
            ...
            $.post('http://fw-phone/GetCurrentEstateagents', JSON.stringify({}), function(data){
                SetupEstate(data);
            });
        }
        ...
        if (PressedServiceTab == "service-cardealer") {
            ...
            $.post('http://fw-phone/GetCurrentCardealers', JSON.stringify({}), function(data){
                SetupCardealer(data);
            });
        }
        ...
        if (PressedServiceTab == "service-taxi") {
            ...
            $.post('http://fw-phone/GetCurrentTaxi', JSON.stringify({}), function(data){
                SetupTaxi(data);
            });
        }
