...
AddEventHandler('framework-housing:server:buy:house', function(HouseId)
    ...
    if Player.PlayerData.money['bank'] >= HousePrice then
      ...
      TriggerEvent("framework-logs:server:SendLog", "realestate", "Huis gekocht", nil, "(citizenid: *" .. Player.PlayerData.citizenid .. "* | " .. Player.PlayerData.name .. " | id: *(" .. src .. ")* Heeft **" .. HouseId .. "** gekocht voor " .. HousePrice .. ". Met karakter: **" .. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .. "**")
    else
...
AddEventHandler('framework-housing:server:add:new:house', function(StreetName, CoordsTable, Price, Tier)
    ...
    TriggerEvent("framework-logs:server:SendLog", "realestate", "Huis aangemaakt", nil, "(citizenid: *" .. Player.PlayerData.citizenid .. "* | " .. Player.PlayerData.name .. " | id: *(" .. src .. ")* Heeft **" .. Name .. "** aangemaakt voor het bedrag " .. Price .. " Met de tier " .. Tier .. ". Met karakter: **" .. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .. "**")
end)
...
AddEventHandler('framework-housing:server:add:garage', function(HouseId, HouseName, Coords)
    ...
    TriggerEvent("framework-logs:server:SendLog", "realestate", "Huis garage aangemaakt", nil, "(citizenid: *" .. Player.PlayerData.citizenid .. "* | " .. Player.PlayerData.name .. " | id: *(" .. src .. ")* Heeft bij **" .. HouseId .. "** een garage aangemaakt. Met karakter: **" .. Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname .. "**")
end)
