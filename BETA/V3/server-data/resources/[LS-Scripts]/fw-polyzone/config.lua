...
Config.CircleZones = {
    ...
    ["Voertuigdealer1"] = {
        name = "Voertuigdealer1",
        coords = vector3(-40.24646, -1094.45, 27.187622),
        radius = 0.70,
        useZ = true,
        debugPoly = false,  
        options = {
            {
                type = "client", 
                event = "framework-vehicleshop:client:open:select:menu",
                icon = "fas fa-receipt",
                label = "Voertuiglijst",
            },
        },
    ...
    ["Voertuigdealer2"] = {
        name = "Voertuigdealer2",
        coords = vector3(-46.9429, -1095.354, 27.397539),
        radius = 0.70,
        useZ = true,
        debugPoly = false,  
        options = {
    ...
    ["Voertuigdealer3"] = {
        name = "Voertuigdealer3",
        coords = vector3(-51.9262, -1095.191, 27.40043),
        radius = 0.70,
        useZ = true,
        debugPoly = false,  
        options = {
...
Config.TargetBones = {
    ...
    ["Kopen"] = {
        ...
        options = {
            {
                type = 'client',
                event = 'framework-vehicleshop:client:open:place:question',
    ...
    options = {
        {
            ...
            canInteract = function()
                if exports['fw-illegal']:IsDealing() then
                    return true
                end
            end,
        },
...
Config.GlobalVehicleOptions = {
    options = {
        ...
        {
            type = 'client',
            event = 'framework-vehicleshop:client:open:place:question', -- framework-vehicleshop:client:buy:vehicle
            icon = 'fas fa-dollar-sign',
            label = 'Voertuig Kopen',
            canInteract = function()
                if exports['fw-vehicleshop']:IsInsideDealer() then
