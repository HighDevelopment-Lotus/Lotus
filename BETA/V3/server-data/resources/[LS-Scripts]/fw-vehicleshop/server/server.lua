...
RegisterServerEvent('framework-vehicleshop:server:set:vehicle')
AddEventHandler('framework-vehicleshop:server:set:vehicle', function(data)
    Config.StoreVehicles[data['Location']]['Vehicle'] = data['Vehicle']
    TriggerClientEvent('framework-vehicleshop:server:sync:config', -1, Config.StoreVehicles)
end)
...
LSCore.Functions.CreateCallback("framework-vehicleshop:server:get:cardealer:vehicles", function(source, cb, category)
    local RetrunTable = {}
...
LSCore.Commands.Add("resetvehicleshop", "Reset voertuigen in PDM", {{name="pdm", help="PDM?"}}, true, function(source, args)
    Config.StoreVehicles[1]['Vehicle'] = GetRandomDealerVehicle('Sport')
    Config.StoreVehicles[2]['Vehicle'] = GetRandomDealerVehicle('Sedan')
    Config.StoreVehicles[3]['Vehicle'] = GetRandomDealerVehicle('Vans')
    Config.StoreVehicles[4]['Vehicle'] = GetRandomDealerVehicle('Muscle')
