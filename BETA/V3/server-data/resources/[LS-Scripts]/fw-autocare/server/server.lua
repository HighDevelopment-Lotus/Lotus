...
LSCore.Functions.CreateCallback("framework-autocare:server:get:config", function(source, cb)
    cb(Config)
end)

LSCore.Functions.CreateCallback('framework-autocare:server:get:vehicle:part', function(source, cb, plate)
...
LSCore.Functions.CreateCallback('framework-autocare:server:has:repair:parts', function(source, cb, partsdata, partclass)
    local src = source
...
RegisterServerEvent('framework-autocare:server:delete:vehicle:data')
AddEventHandler('framework-autocare:server:delete:vehicle:data', function(Plate)
    SaveVehicleParts(Plate, Config.VehiclePartData[Plate])
    Config.VehiclePartData[Plate] = nil
    TriggerClientEvent('framework-autocare:server:sync:parts:config', -1, Config.VehiclePartData)
end)

RegisterServerEvent('framework-autocare:server:set:part:data')
AddEventHandler('framework-autocare:server:set:part:data', function(Plate, Part, Value)
    Config.VehiclePartData[Plate][Part]['Procent'] = Value
    SaveVehicleParts(Plate, Config.VehiclePartData[Plate])
    TriggerClientEvent('framework-autocare:server:sync:parts:config', -1, Config.VehiclePartData)
end)

RegisterServerEvent('framework-autocare:server:set:new:part')
AddEventHandler('framework-autocare:server:set:new:part', function(Plate, Part, Class)
    Config.VehiclePartData[Plate][Part]['Class'] = Class
    SaveVehicleParts(Plate, Config.VehiclePartData[Plate])
    TriggerClientEvent('framework-autocare:server:sync:parts:config', -1, Config.VehiclePartData)
end)

RegisterServerEvent('framework-autocare:server:set:busy:vehicle')
AddEventHandler('framework-autocare:server:set:busy:vehicle', function(Plate, Bool)
    Config.BusyVehicles[Plate] = Bool
    TriggerClientEvent('framework-autocare:server:sync:busy:config', -1, Config.VehiclePartData)
end)

RegisterServerEvent('framework-autocare:server:register:vehicle')
AddEventHandler('framework-autocare:server:register:vehicle', function(Plate, VehicleParts)
...
RegisterServerEvent('framework-autocare:server:do:damage')
AddEventHandler('framework-autocare:server:do:damage', function(Plate)
...
LSCore.Functions.CreateUseableItem("clutch-a", function(source, item)
    ...
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Koppeling', 'A', 'clutch-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("clutch-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Koppeling', 'B', 'clutch-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("clutch-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Koppeling', 'S', 'clutch-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("axle-a", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Aandrijfas', 'A', 'axle-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("axle-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Aandrijfas', 'B', 'axle-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("axle-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Aandrijfas', 'S', 'axle-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("brakes-a", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Remmen', 'A', 'brakes-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("brakes-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Remmen', 'B', 'brakes-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("brakes-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Remmen', 'S', 'brakes-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("engine-a", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Motor', 'A', 'engine-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("engine-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Motor', 'B', 'engine-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("engine-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Motor', 'S', 'engine-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("injectors-a", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Brandstof Injectoren', 'A', 'injectors-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("injectors-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Brandstof Injectoren', 'B', 'injectors-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("injectors-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Brandstof Injectoren', 'S', 'injectors-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("transmission-a", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Transmissie', 'A', 'transmission-a')
    end
end)
...
LSCore.Functions.CreateUseableItem("transmission-b", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Transmissie', 'B', 'transmission-b')
    end
end)
...
LSCore.Functions.CreateUseableItem("transmission-s", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:part', source, 'Transmissie', 'S', 'transmission-s')
    end
end)
...
LSCore.Functions.CreateUseableItem("big-repair", function(source, item)
	local Player = LSCore.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('framework-autocare:client:use:repair', source)
    end
end)
