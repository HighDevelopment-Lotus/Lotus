...
--                     exports['fw-ui']:ShowInteraction('[E] Kaarten Inwisselen', 'primary')
--                 end
--                 if IsControlJustPressed(0, 38) then
--                     CanSell = false
--                     TriggerServerEvent('framework-lottery:server:sell:card')
...
RegisterNetEvent('framework-lottery:client:open:card')
AddEventHandler('framework-lottery:client:open:card', function(id, prize)
