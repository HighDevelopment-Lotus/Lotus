...
-- Events
RegisterNetEvent('framework-tables:client:process:table')
AddEventHandler('framework-tables:client:process:table', function(Type)
    ...
    LSCore.Functions.TriggerCallback('LSCore:HasItem', function(HasItem)
        if HasItem then
            LSCore.Functions.TriggerCallback('framework-tables:server:get:item:amount', function(HasAmount)
                if HasAmount then
...
RegisterNetEvent('framework-tables:client:place:table')
AddEventHandler('framework-tables:client:place:table', function(Type)
    ...
    exports['fw-assets']:RequestAnimationDict("anim@amb@business@weed@weed_inspecting_lo_med_hi@")
...
RegisterNetEvent('framework-tables:client:pickup:table')
AddEventHandler('framework-tables:client:pickup:table', function()
...
function Process(Type)
    ...
    LSCore.Functions.Progressbar("processing-crack", "Verwerking Crack..", ProgressbarTime, false, true, {
        ...
        ClearPedTasks(Player)
        LSCore.Functions.TriggerCallback('framework-tables:server:finish', function() end)
