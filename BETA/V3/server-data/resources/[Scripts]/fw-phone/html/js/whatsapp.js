...
$(document).on('click', '.whatsapp-chat', function(e){
    ...
    $.post('https://fw-phone/ClearAlerts', JSON.stringify({
...
const monthNames = ["Januari", "Februari", "March", "April", "Mei", "Juni", "Juli", "Augustus", "September", "Oktober", "November", "December"];
...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        $.post('https://fw-phone/SendMessage', JSON.stringify({
        ...
        QB.Phone.Notifications.Add("fas fa-comment", "Messages", "Je kan geen leeg bericht plaatsen", "#25D366", 1750);
    }
});
...
QB.Phone.Functions.SetupChatMessages = function(cData, NewChatData) {
    if (cData) {
        ...
        if (OpenedChatPicture == null) {
            $.post('https://fw-phone/GetProfilePicture', JSON.stringify({
...
$(document).on('click', '.whatsapp-shared-location', function(e){
    ...
    $.post('https://fw-phone/SharedLocation', JSON.stringify({
