...
-- // Pawnshop/Smelter
    ...
    ["WeedRegister"] = {
        name = "WeedRegister",
        coords = vector3(375.5503, -827.3314, 29.29378),
        length = 0.5,
        width = 0.8,
        heading = 120,
        debugPoly = false,
    ...
    ["WeedTray"] = {
        name = "WeedTray",
        coords = vector3(377.2616, -827.4157, 29.38479),
        length = 1.1,
        width = 0.8,
        heading = 270,
        debugPoly = false,
    ...
    ["WeedCraft"] = {
        name = "WeedCraft",
        coords = vector3(375.49456, -816.3646, 29.353818),
        length = 0.6,
        width = 1.2,
        heading = 0,
        debugPoly = false,
    ...
    ["Weedstash"] = {
        name = "Weedstash",
        coords = vector3(381.65435, -819.331, 29.336265),
        length = 1.4,
        width = 0.8,
        heading = 0,
        debugPoly = false,
...
Config.TargetBones = {
    ...
    --     options = {
    --         {
    --             event = 'framework-mechanic:usepart:VehicleMenu',
    --             icon = 'fas fa-car',
    --             label = 'Vehicle Menu'
    --         },
    --     },
...
Config.TargetModels = {
    ...
    ["atm"] = {
        ...
        options = {
            ...
            {
                type = "client",
                event = "fw-heists:client:atmrobbery:start",
...
-- // Prison \\
    ...
    ["Arcade"] = {
        ...
        options = {
            {
                event = "framework-arcade:client:openArcadeGames",
                icon = 'fas fa-gamepad',
...
Config.GlobalVehicleOptions = {
    options = {
        ...
        },
        {
            ...
            -- action = function()
            --     if IsPedAPlayer() then return false end
            --     TriggerEvent('framework-illegal:client:try:deliver', '')
            -- end,
    ...
    options = {
        {
            ...
            icon = 'fas fa-mobile',
            label = 'Geef Contact Details',
        },
        {
            event = "framework-vehicles:client:give:key",
            icon = 'fas fa-keys',
            label = 'Geef Sleutels',
        }
    },
