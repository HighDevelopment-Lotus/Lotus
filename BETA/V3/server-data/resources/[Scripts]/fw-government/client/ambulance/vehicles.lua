            ...
            for k, v in pairs(Config.Locations['Garages']) do
                ...
                if Distance < 5.0 then
                    ...
                    if not ShowingGarageInteract then
                        ...
                        exports['fw-ui']:ShowInteraction('[F1] Garage')
                    end
                end
            end
...
RegisterNetEvent('framework-hospital:client:spawn:vehicle')
AddEventHandler('framework-hospital:client:spawn:vehicle', function(VehicleModel)
