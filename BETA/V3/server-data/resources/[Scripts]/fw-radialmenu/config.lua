...
Config.Menu = {
    ...
    [29] = {
       ...
       enableMenu = function()
            if not exports['fw-government']:GetDeathStatus() and (LSCore.Functions.GetPlayerData().job.name == 'cardealer') and LSCore.Functions.GetPlayerData().job.onduty and (exports['fw-cardealer']:InsideCardealer()) and IsPedInAnyVehicle(PlayerPedId()) then
