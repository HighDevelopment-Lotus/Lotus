...
function ConnectRadio(channel)
    ...
    if onRadio then
        exports["framework-voice"]:setRadioChannel(0)
    else
        onRadio = true
        exports["framework-voice"]:setVoiceProperty("radioEnabled", true)
    end

    exports["framework-voice"]:setRadioChannel(channel)
...
function LeaveRadio(Forced)
    if onRadio or Forced then
        ...
        exports["framework-voice"]:removePlayerFromRadio()
        exports["framework-voice"]:SetRadioChannel(0)
        exports["framework-voice"]:setVoiceProperty("radioEnabled", false)
    ...
    Citizen.SetTimeout(150, function()
        if not onRadio then
            ...
            if RadioChannel ~= 0 then
                ...
                exports["framework-voice"]:addPlayerToRadio(RadioChannel, "Radio", "radio")
                exports["framework-voice"]:SetRadioChannel(RadioChannel)
            else
