...
$(document).on('click', '.fireemployee', function(e) {
    ...
    $.post('http://fw-boss/fireEmployee', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.grade-box', function(e) {
    ...
    $.post('http://fw-boss/changeGrade', JSON.stringify({
        grade: gradeid,
...
$(document).on('click', '#option-recruit', function(e) {
    ...
    $.post('http://fw-boss/openRecruit', JSON.stringify({}));
});

$(document).on('click', '#option-bosstash', function(e) {

    $.post('http://fw-boss/openStash', JSON.stringify({}));
});
...
$(document).on('click', '.givejob', function(e) {
    ...
    $.post('http://fw-boss/giveJob', JSON.stringify({
        source: playerid,
    }));
});
...
$(document).on('click', '.deposit', function(e) {
    $.post('http://fw-boss/deposit', JSON.stringify({
        amount: currentDepositAmount,
    }));
});

$(document).on('click', '.withdraw', function(e) {
    $.post('http://fw-boss/withdraw', JSON.stringify({
