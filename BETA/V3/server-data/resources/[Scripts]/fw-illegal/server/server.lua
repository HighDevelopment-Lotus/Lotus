...
Citizen.CreateThread(function()
    Config.Labs[1]['Coords']['Enter'] = {['X'] = -1111.50, ['Y'] = -902.05, ['Z'] = 3.97} -- Meth Lab
    Config.Labs[2]['Coords']['Enter'] = {['X'] = 1384.48, ['Y'] = -2080.11, ['Z'] = 52.41} -- Coke Lab
    ...
    if inTime then
        if Player.Functions.GetItemByName('weed-brick') ~= nil and Player.Functions.GetItemByName('weed-brick').amount >= deliveryData["amount"] then
            ...
            if Player.Functions.GetItemByName('weed-brick').amount >= 0 then
                ...
                Player.Functions.AddMoney('cash', (Player.Functions.GetItemByName('weed-brick').amount * 1000 / 100 * 5))
            end
        ...
        Player.Functions.RemoveItem('weed-brick', deliveryData["amount"])
        Player.Functions.AddMoney('cash', (deliveryData["amount"] * 1000 / 100 * 2), "delivery-drugs-too-late")
