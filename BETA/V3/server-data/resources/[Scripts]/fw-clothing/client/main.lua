...
local LSCore, LoggedIn, PlayerData = exports['fw-base']:GetCoreObject(), false, {}
                        ...
                        if dist < 2 then
                            if PlayerData.job.name == Config.ClothingRooms[k].requiredJob then
                                ...
                                if IsControlJustPressed(0, Keys["E"]) then
                                    ...
                                    LSCore.Functions.TriggerCallback('framework-clothing:server:getOutfits', function(result)
                                        openMenu({
...
RegisterNetEvent('framework-clothing:client:openOutfitMenu')
AddEventHandler('framework-clothing:client:openOutfitMenu', function()
    LSCore.Functions.TriggerCallback('framework-clothing:server:getOutfits', function(result)
        openMenu({
...
RegisterNUICallback('selectOutfit', function(data)
    ...
    TriggerEvent('framework-clothing:client:loadOutfit', data)
end)
...
RegisterNetEvent('framework-clothing:client:openMenu')
AddEventHandler('framework-clothing:client:openMenu', function()
    customCamLocation = nil
    LSCore.Functions.TriggerCallback('framework-clothing:server:getOutfits', function(result)
      openMenu({
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('framework-clothing:saveOutfit', data.outfitName, model, skinData)
end)

RegisterNetEvent('framework-clothing:client:reloadOutfits')
AddEventHandler('framework-clothing:client:reloadOutfits', function(myOutfits)
    SendNUIMessage({
...
RegisterNUICallback('removeOutfit', function(data, cb)
    TriggerServerEvent('framework-clothing:server:removeOutfit', data.outfitName, data.outfitId)
...
function SaveSkin()
	...
	TriggerServerEvent("framework-clothing:saveSkin", model, clothing)
end

RegisterNetEvent('framework-clothing:client:CreateFirstCharacter')
AddEventHandler('framework-clothing:client:CreateFirstCharacter', function()
...
RegisterNetEvent("framework-clothing:loadSkin")
AddEventHandler("framework-clothing:loadSkin", function(new, model, data)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('framework-clothing:client:loadPlayerClothing', data, PlayerPedId())
    end)
end)

RegisterNetEvent('framework-clothing:client:loadPlayerClothing')
AddEventHandler('framework-clothing:client:loadPlayerClothing', function(data, ped)
...
RegisterNetEvent('framework-clothing:client:loadOutfit')
AddEventHandler('framework-clothing:client:loadOutfit', function(oData)
    local ped = PlayerPedId()
