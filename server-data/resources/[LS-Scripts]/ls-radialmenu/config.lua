...
Config.Menu = {
    [1] = {
       ...
       icon = "#citizen-action",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
                return true
            end
       end,
       subMenus = {"citizen:escort", 'citizen:steal', 'citizen:contact', 'citizen:vehicle:getout', 'citizen:vehicle:getin'}
    },
    [2] = {
       id = "animations",
    ...
    [4] = {
       ...
       icon = "#police-action",
       enableMenu = function()
           if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'police' and LSCore.Functions.GetPlayerData().job.onduty then
               return true
           end
       end,
    ...
    [6] = {
       ...
       functionName = "ls-radialmenu:client:send:down",
       enableMenu = function()
            if exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'police' and LSCore.Functions.GetPlayerData().job.onduty then
                return true
            end
       end,
    },
    ...
    [8] = {
       ...
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'ambulance' and LSCore.Functions.GetPlayerData().job.onduty then
                return true
            end
       end,
    ...
    [11] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-garage:client:open:garage:menu",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
    ...
    [12] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-banking:client:open:bank",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
                if exports['ls-banking']:IsNearAnyBank() then
                    return true
                end
            end
     end,
    ...
    [13] = {
       ...
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
                if exports['ls-housing']:HasEnterdHouse() then
                    return true
                end
            end
       end,
    ...
    [14] = {
       ...
       icon = "#judge-actions",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'judge' then
                return true
            end
       end,
    ...
    [15] = {
       ...
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'ambulance' and LSCore.Functions.GetPlayerData().job.onduty then
                local GarageData = exports['ls-hospital']:GetGarageShit()
    ...
    [16] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-materials:client:scrap:vehicle",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
                if exports['ls-materials']:IsNearScrapYard() then
                    return true
                end
            end
     end,
    ...
    [17] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-dealers:client:open:dealer",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() then
                if exports['ls-dealers']:CanOpenDealerShop() then
                    return true
                end
            end
     end,
    ...
    [18] = {
       ...
       icon = "#citizen-action-garage",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'tow' then
                return true
            end
       end,
    ...
    [19] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-police:client:cuff:closest",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and Config.HasHandCuffs then
                return true
            end
     end,
    },
    [20] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-assets:client:getout:trunk",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and exports['ls-assets']:GetInTrunkState() then
              return true
            end
     end,
    },
    [21] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-hospital:client:check:in",
       enableMenu = function()
            if exports['ls-hospital']:NearCheckin() then
                return true
            end
       end,
    },
    [22] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-police:client:spawn:boat",
       enableMenu = function()
            if LSCore.Functions.GetPlayerData().job.name == 'police' and LSCore.Functions.GetPlayerData().job.onduty and IsEntityInWater(GetPlayerPed(-1)) then
                return true
            end
       end,
    },
    [23] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-police:client:open:garage",
       enableMenu = function()
            if LSCore.Functions.GetPlayerData().job.name == 'police' and LSCore.Functions.GetPlayerData().job.onduty and exports['ls-police']:IsNearHeli() then
                return true
            end
       end,
    },
    [24] = {
       ...
       icon = "#taxi-action",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'taxi' then
                return true
            end
       end,
    ...
    [25] = {
       ...
       icon = "#burger-action",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'burger' and LSCore.Functions.GetPlayerData().job.onduty then
                return true
            end
       end,
    ...
    [26] = {
       ...
       icon = "#ambulance-action",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'darkdoctor' and LSCore.Functions.GetPlayerData().job.onduty then
                return true
            end
       end,
    ...
    [27] = {
       ...
       icon = "#plane-action",
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and LSCore.Functions.GetPlayerData().job.name == 'flightschool' and LSCore.Functions.GetPlayerData().job.onduty then
                return true
            end
       end,
    ...
    [28] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-hospital:client:try:repsawn",
       enableMenu = function()
            if exports['ls-hospital']:GetDeathStatus() and exports['ls-hospital']:CanRespawn() then
                return true
            end
       end,
    },
    [29] = {
       ...
       enableMenu = function()
            if not exports['ls-hospital']:GetDeathStatus() and (LSCore.Functions.GetPlayerData().job.name == 'cardealer' or LSCore.Functions.GetPlayerData().job.name == 'motordealer') and LSCore.Functions.GetPlayerData().job.onduty and (exports['ls-cardealer']:InsideCardealer() or exports['ls-motordealer']:IsInsideMotorDealer()) and IsPedInAnyVehicle(GetPlayerPed(-1)) then
                return true
            end
       end,
    },
    [30] = {
       ...
       close = true,
       functiontype = "client",
       functionName = "ls-interactions:client:steal:shoes",
       enableMenu = function()
           if not exports['ls-hospital']:GetDeathStatus() then
...
Config.SubMenus = {
    ['flightschool:add:brevet'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-flightschool:client:open:brevet"
    },
    ['burger:give:payment'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-burgershot:client:give:payment"
    },
    ['taxi:meter:toggle'] = {
     title = "Toggle Meter",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:toggle:taxi:meter"
    },
    ['taxi:meter:active:toggle'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:start:taxi:meter"
    },
    ['taxi:meter:reset'] = {
     title = "Reset Meter",
     icon = "#taxi-refresh",
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:reset:taxi:meter"
    },
    ['taxi:npc'] = {
     title = "Werken",
     icon = "#taxi-action",
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:taxi:npc"
    },
    ['police:radio:one'] = {
     title = "Radio #1",
     icon = "#police-radio",
     ...
     functiontype = "client",
     functionName = "ls-radialmenu:client:enter:radio"
    },
    ['police:radio:two'] = {
     title = "Radio #2",
     icon = "#police-radio",
    ...
    ['police:cams'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:open:number"
    },
    ['police:panic'] = {
     title = "Noodknop",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-radialmenu:client:send:panic:button"
    },
    ['police:dispatch'] = {
     ...
     close = true,
     functiontype = "server",
     functionName = "ls-radialmenu:server:open:dispatch"
    },
    ['police:tablet'] = {
     title = "MEOS Tablet",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:show:tablet"
    },
    ['police:impound'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:impound:closest"
    },
    ['police:impound:force'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:impound:force:closest"
    },
    ['police:search'] = {
     title = "Fouileeren",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:search:closest"
    },
    ['police:resetdoor'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-housing:client:reset:house:door"
    },
    ['police:enkelband'] = {
     title = "Enkelband",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:enkelband:closest"
    },
    ['police:vehicle:touran'] = {
     ...
     functiontype = "client",
     functionName = "ls-police:client:spawn:vehicle"
    },
    ...
    ['ambulance:heal'] = {
      ...
      close = true,
      functiontype = "client",
      functionName = "ls-hospital:client:heal:closest"
    },
    ['ambulance:revive'] = {
      title = "Burger Revive",
      icon = "#ambulance-action-heal",
      close = true,
      functiontype = "client",
      functionName = "ls-hospital:client:revive:closest"
    },
    ['ambulance:blood'] = {
      ...
      close = true,
      functiontype = "client",
      functionName = "ls-hospital:client:take:blood:closest"
    },
    ['ambulance:garage:heli'] = {
      ...
      functiontype = "client",
      functionName = "ls-hospital:client:spawn:vehicle"
    },
    ...
    ['judge:job'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-judge:client:lawyer:add:closest"
    },
    ['citizen:contact'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-phone_new:client:GiveContactDetails"
    },
    ['citizen:escort'] = {
     title = "Escorteren",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:escort:closest"
    },
    ['citizen:steal'] = {
     title = "Beroven",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:steal:closest"
    },
    ['citizen:vehicle:getout'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:set:out:vehicle:closest"
    },
    ['citizen:vehicle:getin'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-police:client:set:in:vehicle:closest"
    },
    ['vehicle:flip'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-radialmenu:client:flip:vehicle"
    },
    ['vehicle:key'] = {
     title = "Geef Sleutel",
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-vehiclekeys:client:give:key"
    },
    ...
    ['vehicle:door:left:front'] = {
     ...
     functiontype = "client",
     functionName = "ls-radialmenu:client:open:door"
    },
    ['vehicle:door:motor'] = {
     title = "Motor Kap",
    ...
    ['tow:hook'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:hook:car:tow"
    },
    ['tow:npc'] = {
     title = "Toggle NPC",
     icon = "#citizen-action",
     close = true,
     functiontype = "client",
     functionName = "ls-jobmanager:client:toggle:npc:tow"
    }, 
    ['house:setstash'] = {
     title = "Zet Stash",
     icon = "#citizen-put-out-veh",
     ...
     functiontype = "client",
     functionName = "ls-housing:client:set:location"
    },
    ['house:setlogout'] = {
     title = "Zet Loguit",
     icon = "#citizen-put-out-veh",
    ...
    ['house:givekey'] = {
     ...
     close = true,
     functiontype = "client",
     functionName = "ls-housing:client:give:keys"
    },
    ['house:decorate'] = {
     title = "Decoreren",
     icon = "#global-box",
     close = true,
     functiontype = "client",
     functionName = "ls-housing:client:decorate"
    },
