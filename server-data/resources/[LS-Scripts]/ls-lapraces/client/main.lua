...
RegisterNetEvent('ls-lapraces:client:StartRaceEditor')
AddEventHandler('ls-lapraces:client:StartRaceEditor', function(RaceName)
...
function SaveRace()
    ...
    TriggerServerEvent('ls-lapraces:server:SaveRace', CreatorData)
...
RegisterNetEvent('ls-lapraces:client:UpdateRaceRacerData')
AddEventHandler('ls-lapraces:client:UpdateRaceRacerData', function(RaceId, RaceData)
...
RegisterNetEvent('ls-lapraces:client:JoinRace')
AddEventHandler('ls-lapraces:client:JoinRace', function(Data, Laps)
    if not RaceData.InRace then
        RaceData.InRace = true
        SetupRace(Data, Laps)
        TriggerServerEvent('ls-lapraces:server:UpdateRaceState', CurrentRaceData.RaceId, false, true)
    else
        LSCore.Functions.Notify('Je zit al in een race..', 'error')
    end
end)

RegisterNetEvent('ls-lapraces:client:LeaveRace')
AddEventHandler('ls-lapraces:client:LeaveRace', function(data)
...
RegisterNetEvent('ls-lapraces:client:RaceCountdown')
AddEventHandler('ls-lapraces:client:RaceCountdown', function()
    TriggerServerEvent('ls-lapraces:server:UpdateRaceState', CurrentRaceData.RaceId, true, false)
                ...
                if CheckpointDistance < MaxDistance then
                    if CurrentRaceData.TotalLaps == 0 then
                        if CurrentRaceData.CurrentCheckpoint + 1 < #CurrentRaceData.Checkpoints then
                            ...
                            SetNewWaypoint(CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.x, CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.y)
                            TriggerServerEvent('ls-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, false)
                            DoPilePfx()
                            ...
                            PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
                            CurrentRaceData.CurrentCheckpoint = CurrentRaceData.CurrentCheckpoint + 1
                            TriggerServerEvent('ls-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, true)
                            FinishRace()
                        end
                    else
                        if CurrentRaceData.CurrentCheckpoint + 1 > #CurrentRaceData.Checkpoints then
...
function FinishRace()
    TriggerServerEvent('ls-lapraces:server:FinishPlayer', CurrentRaceData, CurrentRaceData.TotalTime, CurrentRaceData.TotalLaps, CurrentRaceData.BestLap)
...
RegisterNetEvent('ls-lapraces:client:PlayerFinishs')
AddEventHandler('ls-lapraces:client:PlayerFinishs', function(RaceId, Place, FinisherData)
    if CurrentRaceData.RaceId ~= nil then
...
RegisterNetEvent('ls-lapraces:client:WaitingDistanceCheck')
AddEventHandler('ls-lapraces:client:WaitingDistanceCheck', function()
    Wait(1000)
    Citizen.CreateThread(function()
        while true do
                ...
                if CurrentRaceData.Checkpoints[1] ~= nil then
                    ...
                    if dist > 115.0 then
                        if ToFarCountdown ~= 0 then
                            ...
                            TriggerServerEvent('ls-lapraces:server:LeaveRace', CurrentRaceData)
                            ToFarCountdown = 10
                            break
                        end
                        Citizen.Wait(1000)
