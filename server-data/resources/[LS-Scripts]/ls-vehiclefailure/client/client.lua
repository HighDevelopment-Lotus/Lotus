...
RegisterNetEvent('ls-vehiclefailure:client:fix:veh')
AddEventHandler('ls-vehiclefailure:client:fix:veh', function()
	if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
		...
		SetVehicleFuelLevel(Vehicle, Amount + 0.0)
 		TriggerServerEvent('ls-fuel:server:update:fuel', vehiclePlate, Vehicle, math.floor(Amount))
	else
