...
OpenBankContainer = function(data) {
    ...
    if (data.type === 'bank') {
        CurrentType = 'bank';
        $.post('http://ls-banking/GetAccounts', JSON.stringify({}), function(Accounts){
        ...
        $.post('http://ls-banking/GetSharedAccounts', JSON.stringify({}), function(Accounts){
            for (const [key, value] of Object.entries(Accounts)) {
        ...
        $.post('http://ls-banking/GetBusinessdAccounts', JSON.stringify({}), function(Accounts){
            for (const [key, value] of Object.entries(Accounts)) {
        ...
        $.post('http://ls-banking/GetMyAccount', JSON.stringify({}), function(AccountData){
...
RefreshAccountCards = function() {
    ...
    setTimeout(function() {
        ...
        $.post('http://ls-banking/GetCash', JSON.stringify({}), function(Cash){
...
CloseBankContainer = function() {
    $.post('http://ls-banking/ClickSound', JSON.stringify({}))
    ...
    $.post('http://ls-banking/CloseUi', JSON.stringify({}))
}
...
$(document).on('click', '.player-card-delete', function(e) {
    ...
    $.post('http://ls-banking/ClickSound', JSON.stringify({}))
    $.post('http://ls-banking/DeletePlayer', JSON.stringify({CitizenId: PlayerData['CitizenId'], BankId: CurrentAccountData['BankId']}), function(IsDone){
        if (IsDone) {
            CloseBankContext();
        } else {
            $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
        }
    });
});
...
$(document).on('click', '.context-3-accept', function(e) {
    ...
    $.post('http://ls-banking/ClickSound', JSON.stringify({}))
    $.post('http://ls-banking/AddPlayer', JSON.stringify({CitizenId: AddCid, BankId: CurrentAccountData['BankId']}), function(IsDone){
        if (IsDone) {
            CloseBankContext();
        } else {
            $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
...
$(document).on('click', '.context-button-accept', function(e) {
 ...
 if (Amount !== '') {
    if (CurrentContextType == 'Opname') {
        $.post('http://ls-banking/WithdrawMoney', JSON.stringify({Type: CurrentAccountData['Type'], AccountNumber: CurrentAccountData['BankId'], WithdrawAmount: Amount, WithdrawReason: Reason}), function(IsDone){
            if (IsDone) {
                CloseBankContext();
            } else {
                $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
        ...
        $.post('http://ls-banking/DepositMoney', JSON.stringify({Type: CurrentAccountData['Type'], AccountNumber: CurrentAccountData['BankId'], DepositAmount: Amount, DepositReason: Reason}), function(IsDone){
            if (IsDone) {
                CloseBankContext();
            } else {
                $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
        ...
        $.post('http://ls-banking/TransferMoney', JSON.stringify({Type: CurrentAccountData['Type'], TargetNumber: Account, AccountNumber: CurrentAccountData['BankId'], TransferAmount: Amount, TransferReason: Reason}), function(IsDone){
            if (IsDone) {
                CloseBankContext();
            } else {
                $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
    ...
    $.post('http://ls-banking/CreateAccount', JSON.stringify({Name: AccountName, Type: AccountType}), function(IsDone){
        if (IsDone) {
            CloseBankContext();
        } else {
            $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
...
$(document).on('click', '.remove-account', function(e) {
    ...
    if (CanClick) {
        ...
        var BankData = $("#accout-card-"+BankId).data('AccountData');
        $.post('http://ls-banking/ClickSound', JSON.stringify({}))
        $.post('http://ls-banking/DeleteAccount', JSON.stringify({BankId: BankData['BankId']}), function(IsDone){
            if (IsDone) {
                RefreshAccountCards();
            } else {
                $.post('http://ls-banking/ErrorSound', JSON.stringify({}))
