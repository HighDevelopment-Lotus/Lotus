...
AddEventHandler('LSCore:Client:OnPlayerLoaded', function()
    Citizen.SetTimeout(7000, function()
		LSCore.Functions.TriggerCallback('ls-tattoos:GetPlayerTattoos', function(tattooList)
			if tattooList then
...
function GetNaked()
	...
	if GetEntityModel(PlayerPedId()) == `mp_m_freemode_01` then
		...
		TriggerEvent('ls-clothing:client:loadOutfit', outfitMan)
	elseif GetEntityModel(PlayerPedId()) == `mp_f_freemode_01` then
		...
		TriggerEvent('ls-clothing:client:loadOutfit', outfitFemale)
	else
		LSCore.Functions.TriggerCallback('ls-tattoos:GetPlayerTattoos', function(tattooList)
			if tattooList then
				ClearPedDecorations(PlayerPedId())
...
function BuyTattoo(collection, name, label, price)
	LSCore.Functions.TriggerCallback('ls-tattoos:PurchaseTattoo', function(success)
		if success then
...
function RemoveTattoo(name, label)
	...
	TriggerServerEvent("ls-tattoos:RemoveTattoo", currentTattoos)
