...
RegisterNetEvent('ls-commandbinding:client:openUI')
AddEventHandler('ls-commandbinding:client:openUI', function()
    openBindingMenu()
end)
...
RegisterNUICallback('save', function(data)
    ...
    TriggerServerEvent('ls-commandbinding:server:set:keys', keyData)
