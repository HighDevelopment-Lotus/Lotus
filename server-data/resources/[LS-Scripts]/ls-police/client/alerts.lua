RegisterNetEvent('ls-police:client:send:officer:down')
AddEventHandler('ls-police:client:send:officer:down', function(Coords, StreetName, Info, Priority)
    ...
    exports['ls-alerts']:SendAlert(Data, false)
    AddAlert(Title, 306, 250, Coords, false, true)
end)

RegisterNetEvent('ls-police:client:send:alert:panic:button')
AddEventHandler('ls-police:client:send:alert:panic:button', function(Coords, StreetName, Info)
...
RegisterNetEvent('ls-police:client:send:alert:gunshots')
AddEventHandler('ls-police:client:send:alert:gunshots', function(Coords, GunType, StreetName, InVeh)
...
RegisterNetEvent('ls-police:client:send:alert:dead')
AddEventHandler('ls-police:client:send:alert:dead', function(Coords, StreetName)
    ...
    exports['ls-alerts']:SendAlert(Data, true)
    AddAlert('Gewonde Burger', 480, 250, Coords, false, true)
end)

RegisterNetEvent('ls-police:client:send:bank:alert')
AddEventHandler('ls-police:client:send:bank:alert', function(Coords, StreetName, Name)
...
RegisterNetEvent('ls-police:client:send:alert:jewellery')
AddEventHandler('ls-police:client:send:alert:jewellery', function(Coords, StreetName)
...
RegisterNetEvent('ls-police:client:send:alert:store')
AddEventHandler('ls-police:client:send:alert:store', function(Coords, StreetName, StoreNumber)
...
RegisterNetEvent('ls-police:client:send:house:alert')
AddEventHandler('ls-police:client:send:house:alert', function(Coords, StreetName)
...
RegisterNetEvent('ls-police:client:send:banktruck:alert')
AddEventHandler('ls-police:client:send:banktruck:alert', function(Coords, Plate, StreetName)
...
RegisterNetEvent('ls-police:client:send:explosion:alert')
AddEventHandler('ls-police:client:send:explosion:alert', function(Coords, StreetName)
...
RegisterNetEvent('ls-police:client:send:humanelabs:alert')
AddEventHandler('ls-police:client:send:humanelabs:alert', function(Coords, StreetName)
...
RegisterNetEvent('ls-police:client:send:bobcat:alert')
AddEventHandler('ls-police:client:send:bobcat:alert', function(Coords, StreetName)
...
RegisterNetEvent('ls-police:client:send:prison:alert')
AddEventHandler('ls-police:client:send:prison:alert', function(Coords)
...
RegisterNetEvent('ls-police:client:send:illegal:hunting:alert')
AddEventHandler('ls-police:client:send:illegal:hunting:alert', function(Coords)
...
RegisterNetEvent('ls-police:client:send:oxy:alert')
AddEventHandler('ls-police:client:send:oxy:alert', function(Coords, Street)
...
RegisterNetEvent('ls-police:client:send:call:alert')
AddEventHandler('ls-police:client:send:call:alert', function(Coords, Name, Message)
...
RegisterNetEvent('ls-police:client:send:tracker:alert')
AddEventHandler('ls-police:client:send:tracker:alert', function(Coords, Name)
